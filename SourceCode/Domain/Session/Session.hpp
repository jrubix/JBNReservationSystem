...
namespace Domain::Session
{
  ...
  struct ReceptionistSession  : SessionBase{ ReceptionistSession  ( const UserCredentials & credentials ); };
  struct HotelGuestSession          : SessionBase{ HotelGuestSession    ( const UserCredentials & credentials ); };
